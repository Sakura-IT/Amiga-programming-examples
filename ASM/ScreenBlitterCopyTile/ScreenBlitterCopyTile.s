...
TileBlitterCopy:
		...
		move.w	d0,bltamod(a5)			;modulo A (src)
		move.w	#SCREEN_BROW-2,bltdmod(a5)	;modulo D (dst)
		move.l	#$09f00000,bltcon0(a5)		;D=A
		subq.l	#1,d0
		move.l	d0,bltafwm(a5)			;mask = $ffffffff
		move.l	tile(a6),bltapt(a5)		;src A
		move.l	screen(a6),bltdpt(a5)		;dst D

		move.w	#16*SCREEN_BPL*64+1,bltsize(a5)	;start 
		rts
